  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full bg-white border border-gray-300 text-gray-700 py-3 px-6 rounded-xl text-sm font-semibold hover:bg-gray-50 disabled:opacity-50 transition-colors flex items-center justify-center gap-2.5"
      >
        <span style={{ fontSize: "clamp(0.7rem, 3vw, 0.92rem)" }} className="flex items-center gap-2.5 whitespace-nowrap">
      ...
      >
        {loading === "facebook" ? (
          ...
          <span
            className="flex items-center justify-center gap-1.5 whitespace-nowrap flex-nowrap"
            style={{ fontSize: "clamp(0.7rem, 3vw, 0.92rem)" }}
          >
